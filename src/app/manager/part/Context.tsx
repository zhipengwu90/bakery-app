...
const [snackbar, setSnackbar] = useState<{
  ...
  const handleSaveEdit = async () => {
    setSaving(true);
    try {
      const result = await uploadNewItem(selectedImage, editTitle, editDescription);
      if (result.success) {
  ...
  const handleDeleteCurrentImage = async () => {
    ...
    try {
      ...
      const { error: updateErr } = await supabase
        .from("brazen_page")
        .update({ img_url: null, file_path: null })
        .eq("type", "newItem")
        .eq("id", 1);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 py-12 px-4 sm:px-6 lg:px-8">
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-3">
                <Avatar sx={{ width: 50, height: 50, bgcolor: "#ef4444", fontSize: "1.25rem" }}>
              ...
              <Button
                ...
                sx={{
                  px: 3, py: 1, borderRadius: 2, textTransform: "none",
                  fontSize: "0.875rem", fontWeight: "bold", boxShadow: 2,
          ...
          <div className="col-span-6 lg:col-span-6 md:col-span-12 sm:col-span-12 bg-white border-2 border-red-100 rounded-lg p-6 shadow-lg relative">
            <IconButton
              ...
              sx={{
                ...
                bgcolor: "#ef4444", color: "white", width: 40, height: 40,
                "&:hover": { bgcolor: "#dc2626", transform: "scale(1.1)" },
                transition: "all 0.3s ease", boxShadow: 2,
              }}
            >
              <FaEdit />
            </IconButton>
            ...
            <div className="bg-gradient-to-r my-3 from-green-50 to-orange-50 border-l-4 border-green-500 p-6 rounded-lg">
      ...
      >
        <DialogTitle sx={{ bgcolor: "#ef4444", color: "white", fontWeight: "bold" }}>
          <div className="flex items-center gap-2">
            <FaEdit />
            Edit New Item Section
          </div>
        </DialogTitle>
        <DialogContent sx={{ mt: 2, position: "relative" }}>
          {(saving || deleting) && (
            <Backdrop
              open
              sx={{
          ...
          <div className="space-y-4 pt-2">
            ...
            {newItemData?.img_url ? (
              <div className="mb-2">
                <label className="block text-sm font-semibold text-gray-700 mb-1">Current Image</label>
                <div className="relative border-2 border-red-200 rounded-lg overflow-hidden">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 bg-red-500 hover:bg-red-600 disabled:opacity-60 disabled:cursor-not-allowed text-white rounded-full p-2 transition-all duration-300 shadow-lg"
              ...
              <div className="space-y-3">
                ...
                <Button
                  ...
                  fullWidth
                  sx={{
                    textTransform: "none", py: 1.5, borderWidth: 2,
            ...
            <div className="bg-amber-50 border-l-4 border-amber-400 p-4 rounded">
              <p className="text-sm text-amber-800">
                <strong>Note:</strong> Changes will be reflected immediately on the homepage.
              </p>
            </div>
          </div>
        </DialogContent>
