...
const HourCard = () => {
  const getTodaysHours = () => {
    ...
    return WEEKLY_HOURS[dayIndex];
  };

  const { hours, open } = getTodaysHours();
  ...
  return (
    <div
      className="lg:hidden bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-lg rounded-3xl p-5 shadow-2xl border border-white/20 max-w-md cursor-pointer hover:from-white/25 hover:to-white/10 transition-all duration-300 transform hover:scale-105"
      onClick={handleClick}
    >
